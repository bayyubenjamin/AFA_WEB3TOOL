// src/components/AirdropDetailPage.jsx - VERSI FINAL DENGAN LINK AKTIF DAN WARNA BIRU, SUPPORT GAMBAR DI UPDATE
            ...
            <div className="bg-card border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="my-8">
                        ...
                        {processedTutorial ? (
                            <div
                                className="prose prose-invert prose-sm md:prose-base max-w-none prose-h3:text-primary prose-a:text-blue-500 prose-li:marker:text-primary"
                            ...
                            <div className="space-y-4">
                                {updates.map(update => (
                                    <div key={update.id} className="p-4 bg-dark rounded-lg relative group">
                                        ...
                                        {update.link && (
                                            <a href={update.link} target="_blank" rel="noopener noreferrer" className="btn-secondary text-xs mt-3 inline-block px-4 py-1.5">Kunjungi Link</a>
                                        )}
                                    </div>
                                ))}
                            </div>
