...
                {/* ## PENAMBAHAN: Panel Info Detail Transaksi ## */}
                {transaction.order_type === 'jual' && transaction.user_payment_info && (
...
                            <p><strong>Nama:</strong> {transaction.user_payment_info.fullName}</p>
                            <p><strong>Metode:</strong> {transaction.user_payment_info.details}</p>
                        </div>
                    </div>
                )}
